      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-2">
            <span className={`text-[11px] px-2 py-0.5 rounded-full ${published ? "bg-[#7aff2e]/15 text-[#7aff2e]" : "bg-yellow-500/15 text-yellow-400"}`}>
      ...
      <div className="flex items-center gap-2 shrink-0 flex-wrap justify-end">
        <button
          ...
          className={`text-xs px-3 py-1.5 rounded-lg transition disabled:opacity-50 ${
            published
              ? "bg-yellow-500/10 text-yellow-400 hover:bg-red-500/10 hover:text-red-400"
              : "bg-[#7aff2e]/10 text-[#7aff2e] hover:bg-[#7aff2e]/20"
          }`}
        >
