        ...
        <section className="max-w-7xl mx-auto px-6 pb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {WHY_US.map((item) => (
                    <div
                        key={item.title}
                        className={`bg-white/5 border border-white/8 border-t-2 ${item.border} rounded-xl p-6 flex flex-col gap-3 hover:bg-white/8 transition duration-300 cursor-pointer`}
                    >
